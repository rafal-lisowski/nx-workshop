const games = [
    {
      ...
      image: '/assets/beans (1).png', // 'https://media.giphy.com/media/xUNda3pLJEsg4Nedji/giphy.gif',
      description:
    ...
    },
    {
      id: 'chess-pie',
      name: 'Chess Pie',
      image: '/assets/chess (1).png', // 'https://media.giphy.com/media/iCZyBnPBLr0dy/giphy.gif',
    ...
    },
    {
      id: 'purrfection',
      name: 'Purrfection',
      image: '/assets/cat (1).png', // 'https://media.giphy.com/media/12xMvwvQXJNx0k/giphy.gif',
